...
DELIMITER //
CREATE PROCEDURE TambahKeteranganKategori()
BEGIN
  ALTER TABLE kategori_obat ADD COLUMN IF NOT EXISTS keterangan TEXT;
  SELECT * FROM kategori_obat;
END;//
DELIMITER ;

DELIMITER //
CREATE PROCEDURE LihatTransaksiDenganPelanggan()
BEGIN
...
DELIMITER //
CREATE PROCEDURE UbahTeleponPabrik()
BEGIN
...
DELIMITER //
CREATE PROCEDURE JoinObatKategoriPabrikDanTambahReferensi()
BEGIN
  ...
  ALTER TABLE pelanggan ADD COLUMN IF NOT EXISTS referensi_id INT;
END;//
DELIMITER ;

DELIMITER //
CREATE PROCEDURE FilterObatDanPelanggan()
BEGIN
